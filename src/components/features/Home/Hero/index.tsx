...
import VideoTreeImage from '@/assets/images/tree.svg';
  ...
  return (
    ...
    >
      <div className="relative flex items-center w-full h-max m-auto">
        <motion.div
          className="absolute bottom-0 flex w-[550px] max-w-full right-0 text-tertiary lg:w-[60%] lg:text-secondary -lg:[&_*]:filter-none"
          variants={heroVariants.image}
        >
          <VideoTreeImage className="w-full h-full [&_*]:h-full translate-x-14 translate-y-2" />
        </motion.div>
        <motion.div
