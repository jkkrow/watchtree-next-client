...
export default function Row({ header, description, visual: Visual }: RowProps) {
  return (
    <li className="flex flex-col gap-4 lg:flex-row lg:[&:nth-of-type(even)]:flex-row-reverse">
      <div className="flex-shrink-0 bg-hover w-full h-80 rounded-md shadow-lg lg:w-2/5 lg:max-w-lg">
        <Visual />
      </div>
