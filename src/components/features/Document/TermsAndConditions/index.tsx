  ...
  return (
    <>
      ...
      <p>
        ...
        (referred to in these Terms & Conditions as &quot;WatchTree&quot;,
        &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of the
        WatchTree website and the services accessible from the WatchTree website
      ...
      <ul>
        ...
        <li>
          ...
          WatchTree, that is responsible for your information under this Terms &
          Conditions.
        </li>
        <li>
      ...
      <p>
        ...
        apply to transactions at WatchTree. We&apos;ll be as brief as our
        attorneys will allow. The main thing to remember is that by placing an
        order or making a purchase at WatchTree, you agree to the terms along
        with WatchTree&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, &quot;Suggestions&quot;) provided by you to WatchTree
      ...
      <h2>Cookies</h2>
      <p>
        WatchTree uses &quot;Cookies&quot; to identify the areas of our website
      ...
      <p>
        ...
        to you or to users generally at WatchTree&apos;s sole discretion,
        without prior notice to you. You may stop using the Service at any time.
        You do not need to specifically inform WatchTree when you stop using the
      ...
      <p>
        Termination of this Agreement will not limit any of WatchTree&apos;s
      ...
      <p>
        ...
        kind. To the maximum extent permitted under applicable law, WatchTree,
        ...
        limitation to the foregoing, WatchTree provides no warranty or
      ...
      <p>
        Without limiting the foregoing, neither WatchTree nor any
        WatchTree&apos;s provider makes any representation or warranty of any
        ...
        servers, the content, or e-mails sent from or on behalf of WatchTree are
      ...
      <p>
        ...
        any other term, and WatchTree&apos;s failure to assert any right or
        provision under this Agreement shall not constitute a waiver of such
        right or provision. YOU AND WatchTree AGREE THAT ANY CAUSE OF ACTION
      ...
      <p>
        ...
        you use or purchase other WatchTree&apos;s services, which WatchTree
      ...
      <p>
        ...
        THE ENFORCEMENT OR VALIDITY OF YOUR OR WatchTree&apos;s INTELLECTUAL
      ...
      <p>
        If you and WatchTree don&apos;t resolve any dispute by informal
      ...
      <p>
        The WatchTree Service and its contents are provided &quot;as is&quot;
        and &quot;as available&quot; without any warranty or representations of
        any kind, whether express or implied. WatchTree is a distributor and not
        a publisher of the content supplied by third parties; as such, WatchTree
